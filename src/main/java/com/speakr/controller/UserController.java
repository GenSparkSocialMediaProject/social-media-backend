...
public class UserController {
    ...
    public Vote upvote(@PathVariable int postId)
        ...
        return this.postService.addUpvote(postDAO.getReferenceById(postId),
                user);
    }

    @GetMapping("/posts/upvotes/{postId}")
    public int getUpvotes(@PathVariable int postId)
            throws JsonProcessingException {
